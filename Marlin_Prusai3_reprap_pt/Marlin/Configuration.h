...
#define STRING_VERSION_CONFIG_H __DATE__ "12/25/2015 1313h" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Elena Chong, reprap.pt)" // Who made the changes.
